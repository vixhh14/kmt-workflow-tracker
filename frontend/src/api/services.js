...
export const endTask = (id, reason) => api.post(`/tasks/${id}/end`, { reason });
...
export const operatorHoldTask = (taskId, reason = '') => api.put(`/operator/tasks/${taskId}/hold`, { reason });
...
export const getUserOperationalTasks = (userId) => api.get(`/operational-tasks/user/${userId}`);
